...
// 1. Labor Illusion Loader (Inlined)
...
export default function Home() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
        // In production, replace this with your fetch('/api/generate') logic
        // For now, we use the mock generator to ensure it works immediately
    ...
    <main className="min-h-screen bg-gray-50 flex flex-col font-sans text-slate-900">
      ...
      {!showResults && !isLoading && (
        <div className="flex-1 flex flex-col items-center justify-start pt-10 md:pt-20 px-4 animate-in fade-in duration-700">
          ...
          {/* --- SEO CONTENT SECTION (This is what you wanted!) --- */}
          <div className="w-full max-w-4xl grid md:grid-cols-3 gap-8 pb-20">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Discover the hottest viral products from TikTok and Instagram. Our AI scans social media trends daily to find gifts that are actually cool right now.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Stop buying gift cards. We use psychological profiling to find "Life Improver" gifts that match their specific hobbies, from gardening to gaming.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Whether you need a $20 Secret Santa gift or a $200 anniversary present, our AI filters by price to find the highest-rated items on Amazon.
              </p>
            </div>
          </div>
          {/* --- END SEO SECTION --- */}
